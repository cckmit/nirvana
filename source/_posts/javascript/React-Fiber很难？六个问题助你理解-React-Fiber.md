---
title: React-Fiber很难？六个问题助你理解-React-Fiber
date: 2021-06-10 16:28:03
categories: 前端
---
>原文链接：https://segmentfault.com/a/1190000039682751
...
*   [以 React 为例，说说框架和性能（下）](https://gitbook.cn/m/mazi/columns/5c91c813968b1d64b1e08fde/topics/5cbbf49bbbbba80861a35c64)
...
  Vue 需要做数据双向绑定，需要进行数据拦截或代理，那它就需要在**预编译阶段静态分析模版，分析出视图依赖了哪些数据，进行响应式处理**。而 React 就是**局部重新渲染**，React 拿到的或者说掌管的，所负责的就是一堆**递归 React.createElement** 的执行调用（参考下方经过Babel转换的代码），它无法从模版层面进行静态分析。[JSX 和手写的 render function](https://cn.vuejs.org/v2/guide/render-function.html) 是完全动态的，**过度的灵活性导致运行时可以用于优化的信息不足**。
...
![](https://upload-images.jianshu.io/upload_images/10024246-bf63f4af1758a1d6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
> 资料参考：[以 React 为例，说说框架和性能（下）](https://gitbook.cn/m/mazi/columns/5c91c813968b1d64b1e08fde/topics/5cbbf49bbbbba80861a35c64) | [新兴前端框架 Svelte 从入门到原理](https://mp.weixin.qq.com/s/7GTTAYNf28IvIe2bpfVHuQ)
...
> 资料参考：[React17新特性：启发式更新算法](https://zhuanlan.zhihu.com/p/182411298)
...
![](https://upload-images.jianshu.io/upload_images/10024246-24e57685fc0b174b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/10024246-2e9591f06c838163.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


*   副作用单链表；

![](https://upload-images.jianshu.io/upload_images/10024246-5a856dfe3b02e499.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


*   状态更新单链表；

![](https://upload-images.jianshu.io/upload_images/10024246-2a2e877420419cb3.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/10024246-af622304b300ddf6.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/10024246-a6025c062568958d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/10024246-f0d40740fb3288d0.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


### 直观展示

  正是基于以上这些过程，使用Fiber，我们就有了在社区经常看到的[两张对比图](https://claudiopro.github.io/react-fiber-vs-stack-demo/)。
![](https://upload-images.jianshu.io/upload_images/10024246-ac3eed36c112613f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/10024246-c9ecb1889c2829b9.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
![](https://upload-images.jianshu.io/upload_images/10024246-520b70d99d25deed.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

> 图片来源：[完全理解React Fiber](http://www.ayqy.net/blog/dive-into-react-fiber/)
...
2.  [useTrasition](https://juejin.cn/post/6844903986420514823)：让页面实现 `Pending -> Skeleton -> Complete` 的更新路径, 用户在切换页面时可以停留在当前页面，让页面保持响应。 相比展示一个无用的空白页面或者加载状态，这种**用户体验**更加友好。

  其中 Suspense 可以用来解决请求阻塞的问题，UI 卡顿的问题其实开启 concurrent mode 就已经解决的，但如何利用 concurrent mode 来实现更友好的交互还是需要对代码做一番改动的。

> 资料参考：[Concurrent 模式介绍 (实验性)](https://zh-hans.reactjs.org/docs/concurrent-mode-intro.html) | [理解 React Fiber & Concurrent Mode](https://zhuanlan.zhihu.com/p/109971435) | [11.concurrent mode(并发模式是什么样的)](https://xiaochen1024.com/article_item/600acd69245877002ed5df05) | [人人都能读懂的react源码解析](https://xiaochen1024.com/)
...
![](https://upload-images.jianshu.io/upload_images/10024246-c295bf28b37c18ac.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

> 资料参考：[Facebook 将对 React 的优化实现到了浏览器！](https://mp.weixin.qq.com/s/Lbcu1aa2LQZlddAwIIExqA) | [Faster input events with Facebook’s first browser API contribution](https://engineering.fb.com/2019/04/22/developer-tools/isinputpending-api/)
...
![](https://upload-images.jianshu.io/upload_images/10024246-976bbc3983370d31.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


> 资料参考：[新兴前端框架 Svelte 从入门到原理](https://mp.weixin.qq.com/s/7GTTAYNf28IvIe2bpfVHuQ)
